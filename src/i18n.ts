...
const messages: Record<Language, Record<string, string>> = {
  ja: {
    ...
    pdfResolution: 'PDF解像度', target: '対象', followSync: '同期に従う', allPanes: '全ペイン', rotateLeftTitle: '左90°回転 (Shift+R)', rotateRightTitle: '右90°回転 (R)', flipHTitle: '左右反転 (H)', flipVTitle: '上下反転 (V)',
    ...
    disclaimer: 'このアプリは視覚的に確認を行うもので、ファイル間の一致を保証するものではありません。', compareImages: '比較画像', noImage: '画像なし', cursorNone: 'カーソル: —', language: '言語', japanese: '日本語', english: 'English', licenseInfo: '保存とライセンス', storageBody: '表示設定（同期・グリッド・背景色・言語など）はブラウザの localStorage に保存されます。読み込んだファイルの内容やファイル名は保存されず、外部へ送信されることもありません。',
  ...
  en: {
    ...
    pdfResolution: 'PDF resolution', target: 'Target', followSync: 'Follow sync', allPanes: 'All panes', rotateLeftTitle: 'Rotate left 90° (Shift+R)', rotateRightTitle: 'Rotate right 90° (R)', flipHTitle: 'Flip horizontal (H)', flipVTitle: 'Flip vertical (V)',
    ...
    disclaimer: 'This app is for visual inspection only. It does not guarantee that files match.', compareImages: 'Comparison images', noImage: 'No image', cursorNone: 'Cursor: —', language: 'Language', japanese: '日本語', english: 'English', licenseInfo: 'Storage and licenses', storageBody: 'Display settings such as sync, grid, background and language are saved in localStorage in your browser. The contents and names of the files you open are not saved, and nothing is sent anywhere.',
...
// 日本語圏以外の利用者に日本語のメニューを出しても操作できないため、
// 日本語が優先されていない限り英語にする。優先順位はブラウザの指定に従う。
