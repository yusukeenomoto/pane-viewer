...
const messages: Record<Language, Record<string, string>> = {
  ja: {
    ...
    record: '⏺ 録画', recordTitle: 'ズームやページ送りの操作を動画として保存（最長5分）', stopRecording: '⏹ 停止', stopRecordingWithTime: '⏹ 停止 {time}', stopRecordingTitle: '録画を終了して動画を保存',
    recordingStarted: '録画を開始しました', recordingSaved: '動画を保存しました（{seconds}秒 / {format}）', recordingLimit: '最長5分に達したため録画を終了しました', recordingWebmNote: 'WebM形式です。QuickTimeやPowerPointでは再生できない場合があります',
    recordingUnsupported: 'このブラウザは動画の保存に対応していません', recordingNoArea: '録画する領域がありません', recordingNotStarted: '録画は開始されていません', recordingEmpty: '録画データが空でした', recordingFailed: '録画に失敗しました', recordingError: '録画エラー: {message}',
  ...
  en: {
    ...
    record: '⏺ Record', recordTitle: 'Record zooming and page turns as a video (up to 5 minutes)', stopRecording: '⏹ Stop', stopRecordingWithTime: '⏹ Stop {time}', stopRecordingTitle: 'Finish recording and save the video',
    recordingStarted: 'Recording started', recordingSaved: 'Video saved ({seconds}s / {format})', recordingLimit: 'Recording stopped at the 5 minute limit', recordingWebmNote: 'Saved as WebM, which QuickTime and PowerPoint may not play',
    recordingUnsupported: 'This browser cannot save video', recordingNoArea: 'There is no area to record', recordingNotStarted: 'Recording has not started', recordingEmpty: 'The recording was empty', recordingFailed: 'Recording failed', recordingError: 'Recording error: {message}',
